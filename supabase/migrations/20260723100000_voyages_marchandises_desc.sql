...
-- Ajoute la description marchandises (pour affichage dans la liste du portail)
-- ═══════════════════════════════════════════════════════════════════════════

ALTER TABLE voyages ADD COLUMN IF NOT EXISTS marchandises_desc text;
...
BEGIN
  ...
  INSERT INTO voyages (numero_lv, type, destination, commentaire, poids, ml, grutage, transporteur, parti, parti_le, marchandises_desc)
...
SELECT numero_lv, type, date_creation, destination, poids, ml, grutage, commentaire, parti, parti_le, marchandises_desc
FROM voyages
